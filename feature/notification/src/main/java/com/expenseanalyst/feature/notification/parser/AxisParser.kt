...
class AxisParser : TransactionParser {
    ...
    // Matches "Acct XX9876" and "Fx Card XX9665" and "Card XX9876"
    private val accountPattern = Regex("""(?i)(?:acct|card)\s*[xX*]+(\d{3,4})""")
    ...
    override fun parse(sender: String, body: String): ParsedTransaction? {
        ...
        // Prefer UPI transfer target, then POS "at Merchant" pattern
