...
| Room (SQLite) | 19 migration versions committed; switching ORMs is a full rewrite |
...
- **DB is currently v19.** Next migration = `MIGRATION_19_20` inline in `ExpenseAnalystDatabase.kt`. Never use `fallbackToDestructiveMigration()`.
