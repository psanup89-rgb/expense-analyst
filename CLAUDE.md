...
- **Room** — entities in `data/local/entity/`. **Current version: 6**. All migrations inline in `ExpenseAnalystDatabase.kt`.
...
- 6 entities: Expense, Category, EmiGroup, CurrencyRate, **Account**, **MerchantRule**
